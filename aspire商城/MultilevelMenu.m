...
//商品图片显示
#define kImageDefaultName @"listviewitemimg"
...
-(instancetype)initWithFrame:(CGRect)frame WithData:(NSArray *)data withSelectIndex:(void (^)(NSInteger, NSInteger, id))selectIndex
{
    ...
    if (self)
    {
        ...
        self.bounds = CGRectMake(0, 32, rx.size.width, rx.size.height);
        ...
        */
        ...
        _leftTablew.showsVerticalScrollIndicator = NO;
        ...
        float leftMargin =0;
        self.rightCollection=[[UICollectionView alloc] initWithFrame:CGRectMake(kLeftWidth+leftMargin,0,kScreenWidth-kLeftWidth,frame.size.height-20) collectionViewLayout:flowLayout];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (!cell)
    {
        ...
        UILabel * label=[[UILabel alloc] initWithFrame:CGRectMake(kLeftWidth-0.5, 0, 0.5, 64)];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (meun.price)
    {
         cell.price.text = [NSString stringWithFormat:@"￥%@",meun.price];
    }
    else
    {
         cell.price.text = @"￥***";
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    return CGSizeMake(kScreenWidth - kCellRightLineTag , 80);
}
