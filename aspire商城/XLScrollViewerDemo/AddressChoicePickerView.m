...
////区域 数组2
//@property (strong, nonatomic) NSArray *regionArr2;
////省 数组2
//@property (strong, nonatomic) NSArray *provinceArr2;
////城市 数组2
//@property (strong, nonatomic) NSArray *cityArr2;
////区县 数组2
//@property (strong, nonatomic) NSArray *areaArr2;
...
- (instancetype)init{
    ...
    if (self = [super init]) {
        ...
        self.regionArr = [[NSArray alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"address.plist" ofType:nil]];
...
//        self.provinceArr = self.regionArr2[0][@"provinces"];
//        self.cityArr2 = self.provinceArr2[0][@"cities"];
//        self.areaArr2 = self.cityArr2[0][@"areas"];
        
//        self.locate.region = self.regionArr2[0][@"region"];
//        self.locate.province = self.provinceArr2[0][@"province"];
//        self.locate.city = self.cityArr2[0][@"city"];
