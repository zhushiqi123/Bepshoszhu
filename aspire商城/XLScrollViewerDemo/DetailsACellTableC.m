...
@interface DetailsACellTableC()
{
    int box;
}
@end

@implementation DetailsACellTableC
- (void)awakeFromNib
{
    // Initialization code
    box = 0;
    [Session sharedInstance].details_typeListC_num = box;
...
{
    return  [Session sharedInstance].details_typeListC.count;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.type.text = [Session sharedInstance].details_typeListC[indexPath.row];
    //默认先给第一行加上选定
