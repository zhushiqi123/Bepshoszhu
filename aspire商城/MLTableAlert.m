...
-(void)show
{
    ...
    //选择框背景颜色
	UIImageView *alertBgImage = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"showhead.png"] stretchableImageWithLeftCapWidth:15 topCapHeight:30]];
	...
	self.titleLabel.shadowColor = [[UIColor whiteColor] colorWithAlphaComponent:0.75];
...
//	self.table.backgroundView = [[UIView alloc] init];
	...
	UIImageView *maskShadow = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@""] stretchableImageWithLeftCapWidth:6 topCapHeight:7]];
	...
	self.cancelButton.titleLabel.shadowColor = [[UIColor whiteColor] colorWithAlphaComponent:0.75];
	[self.cancelButton setTitle:self.cancelButtonTitle forState:UIControlStateNormal];
	[self.cancelButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    //取消按钮背景颜色
	[self.cancelButton setBackgroundColor:[UIColor orangeColor]];
//	[self.cancelButton setBackgroundImage:[[UIImage imageNamed:@""] stretchableImageWithLeftCapWidth:5 topCapHeight:0] forState:UIControlStateNormal];
//	[self.cancelButton setBackgroundImage:[[UIImage imageNamed:@"btn_orange_normal.png"] stretchableImageWithLeftCapWidth:5 topCapHeight:0] forState:UIControlStateHighlighted];
