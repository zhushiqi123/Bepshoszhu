...
-(void)scanBLEDevice_scan
{
    ...
    {
//        NSLog(@"SCAN - 扫描到的设备-%@-%@",device.deviceName,device.deviceMac);
...
{
    [STW_BLEService sharedInstance].Service_disconnectHandlerScan = ^(void)
    {
//        NSLog(@"蓝牙断开连接 - Scan");
        [STW_BLEService sharedInstance].isBLEStatus = NO;
...
-(void)addTwoButton
{
    ...
    // 设置标题
    [button_Cancle setTitle:@"Cancel" forState:UIControlStateNormal];
