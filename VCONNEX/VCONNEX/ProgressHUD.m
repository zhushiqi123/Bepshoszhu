...
//    UIAlertView *av = [[UIAlertView alloc] initWithTitle:status message:nil delegate:nil cancelButtonTitle:[[InternationalControl bundle] localizedStringForKey:@"confirm" value:nil table:@"Localizable"] otherButtonTitles:nil];
    
    UIAlertView *av = [[UIAlertView alloc] initWithTitle:status message:nil delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil];
    [av show];
}
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	if (hud == nil)
	{
		...
		hud.translucent = YES;
		hud.backgroundColor = HUD_BACKGROUND_COLOR_NIL;
	...
	if (hud.superview == nil)
	{
		if (interaction == NO)
		{
			...
			background.backgroundColor = HUD_BACKGROUND_COLOR_NIL;
