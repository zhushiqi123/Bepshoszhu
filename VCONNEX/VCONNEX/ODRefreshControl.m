...
- (id)initInScrollView:(UIScrollView *)scrollView activityIndicatorView:(UIView *)activity
{
    ...
    if (self) {
        ...
        indicator.color = VCONNEX_COLOR;//RGBCOLOR(0x00, 0xbe, 0xa4);
        
        _activity = activity ? activity : indicator;
        ...
        _arrowLayer.fillColor = VCONNEX_COLOR.CGColor;//RGBCOLOR(0x00, 0xbe, 0xa4).CGColor; //[[UIColor whiteColor] CGColor];
        [_shapeLayer addSublayer:_arrowLayer];
        
        _highlightLayer = [CAShapeLayer layer];
        _highlightLayer.fillColor = [[UIColor blackColor] CGColor];
