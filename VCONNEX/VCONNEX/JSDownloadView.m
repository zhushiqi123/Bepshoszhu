...
- (CAShapeLayer *)maskCircleLayer{
    ...
    if (!_maskCircleLayer) {
        ...
        _maskCircleLayer.strokeColor = [UPDATECOLOR colorWithAlphaComponent:0.3].CGColor;
...
- (CAShapeLayer *)realCircleLayer{
    ...
    if (!_realCircleLayer) {
        ...
        _realCircleLayer.strokeColor = [UPDATECOLOR colorWithAlphaComponent:1].CGColor;
        _realCircleLayer.strokeColor = UPDATECOLOR.CGColor;
...
- (CAShapeLayer *)arrowLayer{
    ...
    if (!_arrowLayer)
    {
        ...
        _arrowLayer.strokeColor = UPDATECOLOR.CGColor;
...
- (CAShapeLayer *)verticalLineLayer{
    ...
    if (!_verticalLineLayer) {
        ...
        _verticalLineLayer.strokeColor = UPDATECOLOR.CGColor;
...
- (UILabel *)progressLabel{
    ...
    if (!_progressLabel) {
        ...
        _progressLabel.textColor = UPDATECOLOR;
...
- (void)setIsSuccess:(BOOL)isSuccess{
    ...
    else
    {
        ...
        self.progressLabel.text = @"Timeout";
...
- (void)showErrorAnimation
{
    CAAnimationGroup *group = [self.service getLineToSuccessAnimationWithValues:@[
                                                                                  (__bridge id)self.service.arrowEndPath.CGPath,
                                                                                  (__bridge id)self.service.errorPath.CGPath
                                                                                  ]];
    group.delegate = self;
...
{
    //(__bridge id)self.service.verticalLineStartPath.CGPath
    CAAnimationGroup *groupline = [self.service getLineToSuccessAnimationWithValues:@[
                                                                                  (__bridge id)self.service.verticalLineStartPath02.CGPath,
                                                                                  ]];
    groupline.delegate = self;
    
    [self.verticalLineLayer addAnimation:groupline forKey:kSuccessAnimationKey];
