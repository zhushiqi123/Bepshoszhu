...
int check_btn_type; //防止连续点击  0 - 空闲  1 - 繁忙状态
...
{
    if([self check_btn_type_function] || checkMessage == NULL || ![text isEqualToString:checkMessage])
    {
        checkMessage = text;
        NSLog(@"可以显示弹窗");
        //get screen area
            ...
            [self updateNotifierWithAnimation:notifierView withText:text completion:^(BOOL finished)
             {
                 ...
                 if(!shouldDismiss) {
                     ...
                     [separatorImageView setBackgroundColor:UIColorFromRGB(0x00bea4)];
        ...
        else
        {
            ...
            notifierView.backgroundColor = UIColorFromRGB(0x000000); //0x00bea4
            ...
            textLabel.textColor = UIColorFromRGB(0x58ffd0);  //0x00bea4  0xFFFFFF 0x58ffd0
