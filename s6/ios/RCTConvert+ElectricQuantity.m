//
//  RCTConvert+ElectricQuantity.m
//  AwesomeProject
//
//  Created by 朱世琦 on 17/12/19.
//  Copyright © 2017年 Facebook. All rights reserved.
//

#import "RCTConvert+ElectricQuantity.h"

@implementation RCTConvert (ElectricQuantity)
+(valueconfigElectric)valueConfigStructElectric:(id)json{
  ...
    return (valueconfigElectric){ maxvalue,minvalue,startAngleF ,sweepAngleF, unit,format, msectionF,defaultValueF};
}
