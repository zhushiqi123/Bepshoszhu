//
//  RCTConvert+TextDemo.m
//  AwesomeProject
//
//  Created by 朱世琦 on 17/12/18.
//  Copyright © 2017年 Facebook. All rights reserved.
//

#import "RCTConvert+TextDemo.h"

@implementation RCTConvert (TextDemo)
+(valueconfig)valueConfigStruct:(id)json{
  ...
    return (valueconfig){ minvalue,maxvalue,startAngleF ,sweepAngleF, unit,format, msectionF,defaultValueF};
}
@end
